...
import { X, Lock, Mail, RefreshCw, AlertCircle } from 'lucide-react';
...
const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose, onLoginSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-6">
      ...
      <div className="bg-white w-full max-w-md rounded-[2.5rem] p-10 relative z-10 shadow-2xl animate-reveal border border-[#064e3b]/5">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-black text-[#064e3b] mb-2 tracking-tight">Acceso Privado</h2>
          <p className="text-[#064e3b]/50 text-sm font-medium">Ingresa tus credenciales para continuar.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            {loading ? <RefreshCw className="animate-spin" size={18} /> : 'Iniciar Sesión'}
          </button>
        </form>
      </div>
    </div>
